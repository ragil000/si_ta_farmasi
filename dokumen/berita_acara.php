<?php
	...
	$getData1 = $query->select("SELECT * FROM table_dosen d, table_tugas_dosen td WHERE d.id_table_dosen = td.id_table_dosen AND table_tugas_dosen_tugas = 'Ketua Sidang' AND id_table_akun = '$id_table_akun'");
	...
	$getData2 = $query->select("SELECT * FROM table_dosen d, table_tugas_dosen td WHERE d.id_table_dosen = td.id_table_dosen AND table_tugas_dosen_tugas = 'Sekretaris Sidang' AND id_table_akun = '$id_table_akun'");
	...
	$document = file_get_contents("berita_acara.rtf");
	...
	header("Content-disposition: inline; filename=berita_acara_$table_data_akun_nim.doc");
